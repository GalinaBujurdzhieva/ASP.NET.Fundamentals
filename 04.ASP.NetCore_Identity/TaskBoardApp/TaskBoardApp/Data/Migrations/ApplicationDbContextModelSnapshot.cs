            ...
            modelBuilder.Entity("TaskBoardApp.Data.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BoardId = 1,
                            CreatedOn = new DateTime(2022, 9, 15, 22, 44, 54, 900, DateTimeKind.Local).AddTicks(2729),
                            Description = "Learn using ASP.NET Core identity",
                            OwnerId = "f8e87948-0db1-4162-8424-181ea3db3d0a",
                        ...
                        new
                        {
                            Id = 2,
                            BoardId = 3,
                            CreatedOn = new DateTime(2022, 5, 15, 22, 44, 54, 900, DateTimeKind.Local).AddTicks(2769),
                        ...
                        new
                        {
                            Id = 3,
                            BoardId = 2,
                            CreatedOn = new DateTime(2022, 10, 5, 22, 44, 54, 900, DateTimeKind.Local).AddTicks(2772),
                            Description = "Learn using ASP.NET Core identity",
                            OwnerId = "f8e87948-0db1-4162-8424-181ea3db3d0a",
                            Title = "Improve ASP.NET Core Skills"
                        },
                        new
                        {
                            Id = 4,
                            BoardId = 3,
                            CreatedOn = new DateTime(2021, 10, 15, 22, 44, 54, 900, DateTimeKind.Local).AddTicks(2775),
            ...
            modelBuilder.Entity("TaskBoardApp.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f8e87948-0db1-4162-8424-181ea3db3d0a",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "06675eea-88ec-479e-ac55-8ff2e93f4017",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJMYwss6UsoZK6PaaJtOZ99u/4XPIZR/hVcW8SJPKKw2T+AJmGnqQo+BL2DwswwpKQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "bbfe9641-7270-4699-a6e8-82eb153a5c1b",
